...
export declare const Empty: import("@storybook/core/csf").AnnotatedStoryFn<import("@storybook/react/dist/types-5617c98e").R, import("..").MapProps & {
    children?: React.ReactNode;
} & React.RefAttributes<mapkit.Map | null>>;
export declare const FixedSize: StoryFn<MapProps>;
export declare const CustomizedAppearance: import("@storybook/core/csf").AnnotatedStoryFn<import("@storybook/react/dist/types-5617c98e").R, import("..").MapProps & {
    children?: React.ReactNode;
} & React.RefAttributes<mapkit.Map | null>>;
export declare const RegionLock: import("@storybook/core/csf").AnnotatedStoryFn<import("@storybook/react/dist/types-5617c98e").R, import("..").MapProps & {
    children?: React.ReactNode;
} & React.RefAttributes<mapkit.Map | null>>;
